...
- **Design import** from a running app, HTML, or Claude, into real layers, or designed with Claude right on the canvas ([guide 12](docs/guides/12-importing-designs.md)).
