This is Placemark's Discover screen, imported from a design: four place cards in the Cards group, the ✕ and ♥ buttons in Vote Buttons, and End of Deck with its Find more places button under the deck. Make the deck work, and put every number that sets its feel on knobs, so I can compare my proposal with what the shipped app does.
