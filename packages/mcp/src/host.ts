...
export interface SimValuesResult extends SimState {
  values: Record<string, unknown>;
  /**
   * Plain-words notes for targets whose value needs one, by target: why it reads as null or an
   * empty loop ("Not drawn: Layer "Card" has 0 copies because ..."), or that "#n" is past the end.
   */
