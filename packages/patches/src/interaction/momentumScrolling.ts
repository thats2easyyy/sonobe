...
import { finiteInput, withMutedBehavior } from "./shared.ts";
...
export const momentumScrolling = withMutedBehavior(
  definePatch<MomentumScrollingState>("momentumScrolling", {
    state: () => ({ scroller: null }),
    evaluate(ctx) {
