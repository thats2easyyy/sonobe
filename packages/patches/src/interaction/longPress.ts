...
import { TOUCH_SLOP, layerInput, samePoint, withMutedBehavior, type Vec2 } from "./shared.ts";
...
export const longPress = withMutedBehavior(
  definePatch<LongPressState>("longPress", {
