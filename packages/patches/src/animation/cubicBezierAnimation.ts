...
import { cubicBezierEase, finiteComponents, readBezierControls, requireSpec, variantOf } from "./shared.ts";
...
export const cubicBezierAnimation = definePatch<CubicBezierAnimationState>("cubicBezierAnimation", {
