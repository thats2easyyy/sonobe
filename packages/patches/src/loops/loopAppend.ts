...
import { indices, passThroughWhenMuted, snapshot, variantPortsFor, warnIfLooped, withMutedBehavior } from "./shared.ts";
...
export const loopAppendPatch = withMutedBehavior(
  definePatch<LoopAppendState>("loopAppend", {
    dynamicPorts: variantPortsFor("loopAppend"),
