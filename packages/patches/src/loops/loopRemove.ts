...
import { cachedReplay, indices, passThroughWhenMuted, variantPortsFor, warnIfLooped, withMutedBehavior } from "./shared.ts";
...
export const loopRemovePatch = withMutedBehavior(
  definePatch<LoopRemoveState>("loopRemove", {
    dynamicPorts: variantPortsFor("loopRemove"),
