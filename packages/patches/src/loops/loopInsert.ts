...
import { cachedReplay, indices, passThroughWhenMuted, snapshot, warnIfLooped } from "./shared.ts";
...
export const loopInsertPatch = definePatch<LoopInsertState>("loopInsert", {
