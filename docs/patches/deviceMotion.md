...
- Available stays false on an iPhone: iOS asks permission first and only on secure (https) pages. Open the prototype from a secure link, then tap it once so iOS can ask.
