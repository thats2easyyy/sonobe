/**
 * Captures noddit-discover.html into capture.json and downloads its photos into photos/, the way
 ...
 *
 *   node examples/16-noddit-deck/design/capture.ts
 *
 * Then rebuild with node examples/build.ts 16-noddit-deck. photos.json names every photo's file and
...
const html = readFileSync(path.join(here, "noddit-discover.html"), "utf8");
