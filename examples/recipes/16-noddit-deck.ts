/**
 * 16 Noddit Deck: the deck from a real test session, rebuilt as an example. The layers come from a
 * design import (16-noddit-deck/design, planned with planImport), and one batch turns the top card
...
export const nodditDeck: Recipe = {
  folder: "16-noddit-deck",
  name: "Noddit Deck",
  ...
  design: { capture: "16-noddit-deck/design/capture.json", photos: "16-noddit-deck/design/photos.json" },
  tidy: "frames",
  ops: () =>
    linkAhead([
