...
- [x] Steady nodes: a running prototype doesn't resize patch nodes. Live values keep the room of the longest text their type prints and knob chips the room of their slider's longest value, in the patch editor and in the headless size model alike
