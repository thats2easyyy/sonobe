...
try {
  ...
  const target = path.join(temp, "Projects", "Noddit Deck.sonobe");
  ...
  assert(JSON.parse(readFileSync(path.join(target, "project.json"), "utf8")).name === "Noddit Deck", "the project takes the folder's name");
