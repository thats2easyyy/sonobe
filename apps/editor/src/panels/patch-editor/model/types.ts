/**
 * Patch editor view model: what the graph canvas renders, derived from a component (patch nodes,
 * layer property targets, component interface nodes, comments, and cables). Pure data; React Flow
 * node and edge shapes carry these as `data`.
 */

import type { EnumOption, Id, InputValue, PatchCategory, Suggestion, Value, ValueSubtype, ValueType } from "@sonobe/core";
