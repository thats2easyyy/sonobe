...
const SHOTS = [
  ...
  { name: "assistant-sub-api-key-chat", view: "sub-api-key-chat" },
  { name: "assistant-sub-api-key-chat-light", view: "sub-api-key-chat", theme: "light" },
  { name: "assistant-sub-unknown", view: "sub-unknown" },
  { name: "assistant-sub-key-choice-light", view: "sub-choice", theme: "light" },
