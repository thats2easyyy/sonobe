/** Byte helpers for assets and the clipboard: base64 and SHA-256 (Web Crypto, with a pure fallback). */

export const toUint8Array = (bytes: ArrayBuffer | Uint8Array): Uint8Array => (bytes instanceof Uint8Array ? bytes : new Uint8Array(bytes));
...
/** Decode base64 (standard or URL-safe); null when it isn't valid. */
...
/** SHA-256 in plain TypeScript (for contexts without Web Crypto, such as insecure origins). */
export function sha256HexSync(input: ArrayBuffer | Uint8Array): string {
